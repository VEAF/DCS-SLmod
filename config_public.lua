...
admin_tools = true
	...
	admin_tools_mission_folder = [[C:\Users\veaf\Saved Games\DCS.missions\_slmod]]
	...
	admin_register_password = "SlMod4VEAF"
...
voteConfig.requireAdminVerifyIfPresent = true
...
--If true, SLMOD will not add the custom MOTD to the standard MOTD but use the custom MOTD only
custom_MOTD_only = true

--Enter your custom MOTD here.  It replaces the first line of the default MOTD.
custom_MOTD = [[
Bienvenue sur le serveur de la VEAF.

**************************
* Lisez la documentation *
**************************

- Documentation de la mission https://tinyurl.com/veaf-ot

************************************
* Utilisation de SRS _obligatoire_ *
************************************

- SRS: srs.veaf.org (autoconnect)
- Mettez-vous sur la fréquence UHF de votre aéroport !
 
******************************************
* Venez nous parler pour partager ce vol *
******************************************

- TeamSpeak: ts.veaf.org
- Discord: https://tinyurl.com/veafdisc
