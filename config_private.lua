...
autoAdmin.autoSpecEnabled = false
...
autoAdmin.teamKill.enabled = false
...
autoAdmin.teamCollisionKill.enabled = false
...
custom_MOTD = [[Bienvenue sur le serveur privé de la VEAF.]]
